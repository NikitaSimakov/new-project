...
function onClick(event) {
  fetchCat().then(function (data) {
    container.innerHTML = "";
    createMarkup(data);
  });
}
function fetchCat() {
  return fetch("https://aws.random.cat/meow").then(function (resp) {
    if (!resp.ok) {
      throw new Error();
    }
    return resp.json();
  }).catch(function (error) {
    _notiflixNotifyAio.Notify.failure(error);
    return error;
  });
}
...
function createMarkup(data) {
  var markup = "<img src='".concat(data.file, "'></img>");
  container.insertAdjacentHTML("beforeend", markup);
}
},{"notiflix/build/notiflix-notify-aio":"node_modules/notiflix/build/notiflix-notify-aio.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/new-project.e31bb0bc.js.map